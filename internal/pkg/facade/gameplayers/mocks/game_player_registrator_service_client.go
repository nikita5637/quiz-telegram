...
// UpdatePlayerDegree provides a mock function with given fields: ctx, in, opts
func (_m *GamePlayerRegistratorServiceClient) UpdatePlayerDegree(ctx context.Context, in *gameplayer.UpdatePlayerDegreeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *emptypb.Empty
	if rf, ok := ret.Get(0).(func(context.Context, *gameplayer.UpdatePlayerDegreeRequest, ...grpc.CallOption) *emptypb.Empty); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*emptypb.Empty)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gameplayer.UpdatePlayerDegreeRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// GamePlayerRegistratorServiceClient_UpdatePlayerDegree_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdatePlayerDegree'
type GamePlayerRegistratorServiceClient_UpdatePlayerDegree_Call struct {
	*mock.Call
}

// UpdatePlayerDegree is a helper method to define mock.On call
//  - ctx context.Context
//  - in *gameplayer.UpdatePlayerDegreeRequest
//  - opts ...grpc.CallOption
func (_e *GamePlayerRegistratorServiceClient_Expecter) UpdatePlayerDegree(ctx interface{}, in interface{}, opts ...interface{}) *GamePlayerRegistratorServiceClient_UpdatePlayerDegree_Call {
	return &GamePlayerRegistratorServiceClient_UpdatePlayerDegree_Call{Call: _e.mock.On("UpdatePlayerDegree",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *GamePlayerRegistratorServiceClient_UpdatePlayerDegree_Call) Run(run func(ctx context.Context, in *gameplayer.UpdatePlayerDegreeRequest, opts ...grpc.CallOption)) *GamePlayerRegistratorServiceClient_UpdatePlayerDegree_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*gameplayer.UpdatePlayerDegreeRequest), variadicArgs...)
	})
	return _c
}

func (_c *GamePlayerRegistratorServiceClient_UpdatePlayerDegree_Call) Return(_a0 *emptypb.Empty, _a1 error) *GamePlayerRegistratorServiceClient_UpdatePlayerDegree_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
