...
var dictionary = map[string]map[string]string{
	"ru": {
		...
		"legioner_by":                                     "Легионер от",
		"legioner_is_likely_to_come":                      "Легионер придёт",
		"legioner_is_unlikely_to_come":                    "Легионер может быть придёт",
		"legioner_will_not_come":                          "Легионер не придёт",
